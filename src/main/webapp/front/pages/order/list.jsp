	...
	<body style="background: #EEEEEE;">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" onclick="addshouhou()" class="btn btn-primary">
								提交
							</button>
						</div>
					</div><!-- /.modal-content -->
		...
		<script>
            ...
            function addshouhou() {
                ...
                /*layui.http.request("shouhou/add", 'get', {
                    suqiu: suqiu,
                    orderid: orderid
                }, function(res) {
                    if(res.code==0){
...
/*
            $('#suqiuupload').fileupload({
                url: 'http://localhost:8080/jspm1d02b/file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: 'json',
                done: function (e, data) {
                    UE.getEditor('suqiuEditor').execCommand('insertHtml', '<img src=\"http://localhost:8080/jspm1d02b/file/upload/' + data.result.file + '\" width=900 height=560>');
                }
            });
